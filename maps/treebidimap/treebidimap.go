...
import (
	...
	"github.com/qauzy/chocolate/trees/redblacktree"
...
func NewWithIntComparators() *Map[int, int] {
	return NewWith[int, int](utils.IntComparator, utils.IntComparator)
}
...
func NewWithStringComparators() *Map[string, string] {
	return NewWith[string, string](utils.StringComparator, utils.StringComparator)
}
