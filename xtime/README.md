...
[![Time Release](https://img.shields.io/github/release/golang-module/carbon.svg)](https://github.com/golang-module/carbon/releases)
...
[![Time Doc](https://img.shields.io/badge/go.dev-reference-brightgreen?logo=go&logoColor=white&style=flat)](https://pkg.go.dev/github.com/golang-module/carbon)
...
Time has been included by [awesome-go](https://github.com/avelino/awesome-go#date-and-time "awesome-go"), if you think
...
carbon.Now(Time.NewYork).ToDateTimeString() // 2020-08-05 14:14:15
carbon.SetTimezone(Time.NewYork).Now().ToDateTimeString() // 2020-08-05 14:14:15
...
carbon.Yesterday(Time.NewYork).ToDateTimeString() // 2020-08-04 14:14:15
carbon.SetTimezone(Time.NewYork).Yesterday().ToDateTimeString() // 2020-08-04 14:14:15
...
carbon.Tomorrow(Time.NewYork).ToDateTimeString() // 2020-08-06 14:14:15
carbon.SetTimezone(Time.NewYork).Tomorrow().ToDateTimeString() // 2020-08-06 14:14:15
...
```go
// Create a Time instance from a given timestamp with second
...
// Create a Time instance from a given timestamp with millisecond
...
// Create a Time instance from a given timestamp with microsecond
...
// Create a Time instance from a given timestamp with nanosecond
...
// Create a Time instance from a given year, month, day, hour, minute and second
...
// Create a Time instance from a given year, month and day
...
// Create a Time instance from a given hour, minute and second
...
##### Parse a standard string as a Time instance
...
```go
// Convert Time.time into Time
carbon.Time2Time(time.Now())
// Convert Time into Time.time
carbon.Now().Time2Time()
```
...
// Whether between two Time instances, excluded the start and end Time instance
...
// Whether between two Time instances, included the start Time instance
...
// Whether between two Time instances, included the end Time instance
...
// Whether between two Time instances, included the start and end Time instance
...
* [briannesbitt/carbon](https://github.com/briannesbitt/Time)
