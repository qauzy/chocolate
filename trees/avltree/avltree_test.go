...
func TestAVLTreePut(t *testing.T) {
	...
	if actualValue, expectedValue := fmt.Sprintf("%s%s%s%s%s%s%s", values1...), "abcdefg"; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
...
func TestAVLTreeRemove(t *testing.T) {
	...
	if actualValue, expectedValue := fmt.Sprintf("%s%s%s%s", values1...), "abcd"; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
	...
	if actualValue, expectedValue := fmt.Sprintf("%s%s%s%s", values2...), "abcd"; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
