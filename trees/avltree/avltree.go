...
// Key should adhere to the comparator's type assertion, otherwise method panics.
func (t *Tree[K, V]) Get(key interface{}) (value interface{}, found bool) {
	n := t.Root
	for n != nil {
...
// Key should adhere to the comparator's type assertion, otherwise method panics.
func (t *Tree[K, V]) Remove(key interface{}) {
	t.remove(key, &t.Root)
}
...
func (t *Tree[K, V]) Keys() []interface{} {
...
//
// Key should adhere to the comparator's type assertion, otherwise method panics.
func (t *Tree[K, V]) Floor(key interface{}) (floor *Node[K, V], found bool) {
	found = false
	n := t.Root
	for n != nil {
...
func (t *Tree[K, V]) remove(key interface{}, qp **Node[K, V]) bool {
	q := *qp
	if q == nil {
		return false
	}
