...
func (t *Time) PlusDays(d int) *Time {
	*t = t.Add(Duration(d) * Hour * 24)
	return t
}

func (t *Time) MinusDays(d int) *Time {
	*t = t.Add(-Duration(d) * Hour * 24)
	return t
}
...
func runtime.now() (sec int64, nsec int32, mono int64)
...
func Now() Time {
	n := time.Now()
	return Date(n.Year(), Month(n.Month()), n.Day(), n.Hour(), n.Minute(), n.Second(), n.Nanosecond(), Local)
}
